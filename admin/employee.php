                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                <td >
                                    <img src="../asset/img/<?php echo $row["image"]; ?>" alt="Employee Image" style="height: 50px; width: 50px">
                                </td>
                                <td class="bg-success"><?php echo $row["username"];    ?></td>
                                <td class="bg-warning" type="password"><?php echo $row["password"];     ?></td>
