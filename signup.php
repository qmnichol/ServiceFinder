...
if(isset($_POST["submit"])){
   ...
   $connection = mysqli_connect("localhost", "root", "", "service_finder");
	...
	$sql = "INSERT INTO sign_up (fname, mname, lname, Gender, age, bdate, cnum, Email, username, valid, ncc, password, image, address) VALUES ('$fname', '$mname', '$lname', '$Gender', '$age', '$bdate', '$cnum', '$Email', '$username', '$valid', '$ncc', '$password', '$profileImage', '$address')";
                           ...
                           <!----------------- profile information  -->
                             <div class="col-md-9">
                                ...
                                <div class="row">
                                   ...
                                   <!-- <div class="col-md-12">
                                       <div class="card-header">
                                          <span class="fa fa-key"> Attach Photo (Valid ID or Barangay ID)</span>
                                       </div>
                                   </div>
                                 <div class="col-md-12">
                                  <div class="form-group">
                                     <div class="input-group">
                                        <div class="custom-file">
                                           <input type="file" class="custom-file-input" id="exampleInputFile">
                                           <label class="custom-file-label" for="exampleInputFile" name="valid" required="require">Choose file</label>
                                        </div>
                                     </div>
                                  </div> -->
