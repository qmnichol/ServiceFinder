    ...
    <div class="login-box" style="width: 30%;margin-left: 35%;margin-top: 100px;margin-bottom: 20px;">
        <div class="card card-outline card-success">
            ...
            <div class="card-header text-center">
              ...
              <h1 class="align-item-center" style="text-align:center;">Admin Login</h1>
           </div>
           <?php
                if (isset($msg)) {
                    ?>
            ...
            <div class="card-body">
                <div class="input-group mb-3">
                 ...
                 <div class="input-group mb-3">
                    <input type="password" class="form-control" placeholder="password" name="password" required="require" id="password">
                    <div class="input-group-append">
                       <div class="input-group-text">
                          <span ><li class="far fa-eye" aria-hidden="true" id="eye" style="cursor: pointer" onclick="toggle()"></li></span>
                       </div>
                    </div>
                 </div>
                 <div class="row">
